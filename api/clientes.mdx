...
<Card title="GET /Database/clientes/" icon="list">
...
<Card title="GET /Database/clientes/{id}/" icon="user">
...
<Card title="POST /Database/clientes/" icon="plus">
...
<Card title="PUT /Database/clientes/{id}/" icon="pen">
...
<Card title="PATCH /Database/clientes/{id}/" icon="pen-to-square">
...
<Card title="DELETE /Database/clientes/{id}/" icon="trash">
...
```bash
curl -X POST https://api.example.com/Database/clientes/ \
...
```bash
curl -X PATCH https://api.example.com/Database/clientes/1/ \
  -H "Content-Type: application/json" \
  -d '{
    "id_campana": 20
  }'
...
```bash
curl -X GET "https://api.example.com/Database/clientes/?estado=1&id_empresa=5"
```

### Updating Client Contact Information

```bash
curl -X PATCH https://api.example.com/Database/clientes/3/ \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X PATCH https://api.example.com/Database/clientes/2/ \
  -H "Content-Type: application/json" \
  -d '{
    "estado": 0
  }'
