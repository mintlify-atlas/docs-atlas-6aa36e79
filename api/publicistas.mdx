...
<RequestExample>
```bash cURL
curl -X POST https://api.example.com/Database/Database/publicistas/ \
...
<RequestExample>
```bash cURL
curl -X GET https://api.example.com/Database/Database/publicistas/5/
```
...
<RequestExample>
```bash cURL
curl -X GET https://api.example.com/Database/Database/publicistas/
```
...
<RequestExample>
```bash cURL
curl -X PUT https://api.example.com/Database/Database/publicistas/5/ \
  -H "Content-Type: application/json" \
  -d '{
    "id_usuario": 8,
    "ruc": "1234567890002",
...
<RequestExample>
```bash cURL
curl -X DELETE https://api.example.com/Database/Database/publicistas/5/
```
...
<RequestExample>
```bash cURL
curl -X GET "https://api.example.com/Database/Database/publicistas/?estado=1"
```
...
<RequestExample>
```bash cURL
curl -X GET "https://api.example.com/Database/Database/publicistas/?id_ciudad=1&id_pais=1"
```
